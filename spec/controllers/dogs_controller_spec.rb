  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested dog" do
        ...
        Dog.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => dog.to_param, :dog => {'these' => 'params'}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the dog as @dog" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Dog.any_instance.stub(:save).and_return(false)
        put :update, {:id => dog.to_param, :dog => {}}, valid_session
        assigns(:dog).should eq(dog)
      end
